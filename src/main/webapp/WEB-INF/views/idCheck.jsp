...
<div class = "find_id_page">
	<h3 class = "find_title">아이디 / 비밀번호 찾기</h3>
		...
		<div class=id_info>
			<form action="/mybatis/findId" method="post">
				<div>
				...
				<div class="find_area_phone">
					<div class="name_input">
						<input class="name_input" type="text" name="name" placeholder="이름을 입력하세요">
					</div>
					<br>
		...
		<!-- --------------------------비밀번호----------------------------------	 -->
		<div class="pw_info">
			<form action="/mybatis/findPsw" method="post">
				<br>
				...
				<div class="find_area_phone_pw">
					...
					<br>
					<div class="phone_input">
						<input class="phone_input" type="text" name="email"
				...
				<div class="find_foot" style="border-top: solid 0.5px black;">
					...
					<div style="margin: 0 auto; width: 150px;">
						<a class="find_footer_btn" role="botton" id="btn_find"
